...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-secondary/10 to-primary/5">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            The visionary behind Kishore Jena Creation, bringing stories to life through expert editing and creative
            design
          </p>
        </motion.div>
              ...
              >
                <div className="w-32 h-32 lg:w-40 lg:h-40 rounded-full overflow-hidden shadow-xl">
                  <Image
                    ...
                    alt="Kishore Jena - Founder & Creative Director"
                    width={160}
                    height={160}
                ...
                {achievements.map((achievement, index) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-foreground mb-1">{achievement.title}</h5>
