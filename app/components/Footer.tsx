...
import DualCameraWithFilters from "@/components/DualCameraWithFilters"
  ...
  return (
    <footer className="bg-background border-t border-border">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        >
          <div className="bg-gray-100 rounded-2xl p-6 max-w-3xl mx-auto shadow-inner">
            <h3 className="text-xl font-bold mb-4 text-foreground">📸 Take a Selfie with CAYA</h3>
            <p className="text-sm text-muted-foreground mb-4">
              🧑‍🤝‍🧑 Capture yourself using both front & back cameras. Add cool filters and save your moment!
            </p>
