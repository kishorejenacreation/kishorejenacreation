...
const services = [
  {
    ...
    title: "Video Editing",
    description: "Professional video editing with After Effects and Premiere Pro for all your creative needs.",
  },
  {
    icon: <PhotoIcon className="w-12 h-12 mb-4 text-green-500" />,
    title: "Photo Editing",
    description: "Expert photo manipulation and enhancement using industry-standard software.",
  },
  {
    icon: <RectangleStackIcon className="w-12 h-12 mb-4 text-purple-500" />,
    title: "Thumbnail Design",
    description: "Eye-catching thumbnails for YouTube, social media, and digital platforms.",
  },
  {
    icon: <HeartIcon className="w-12 h-12 mb-4 text-red-500" />,
    title: "Wedding Invitations",
    description: "Beautiful and elegant wedding invitation designs for your special day.",
  },
  {
    icon: <PaintBrushIcon className="w-12 h-12 mb-4 text-yellow-500" />,
    title: "Graphic Design",
    description: "Creative graphic design solutions for branding, logos, and marketing materials.",
  },
  {
    icon: <MusicalNoteIcon className="w-12 h-12 mb-4 text-purple-600" />,
    title: "Audio Editing",
    description: "Professional audio editing and mixing for podcasts, music, and videos.",
  },
]
