      ...
      <div className="mx-auto max-w-7xl px-6 py-20 sm:py-24 lg:px-8">
        ...
        >
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-6 max-w-md mx-auto">
            ...
            <div className="text-3xl font-bold text-primary mb-2">{timeString}</div>
            <div className="text-sm text-muted-foreground mb-1">{dateString}</div>
            <div className="text-xs text-muted-foreground">Timezone: {getTimeZone()}</div>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-yellow-100 text-black rounded-2xl p-6 max-w-md mx-auto shadow-lg">
            ...
            <p className="text-xs mt-2 text-muted-foreground">
              ...
              Powered By Kishore Jena Creation
            </p>
          </div>
        </motion.div>
        ...
        {/* Nav Links */}
        <nav className="mb-10 sm:flex sm:justify-center sm:space-x-12 text-center" aria-label="Footer">
          {["About", "Work", "Services", "Contact", "Privacy", "Terms"].map((item, i) => (
            <Link
              key={i}
              href={`#${item.toLowerCase()}`}
              className="block text-sm text-muted-foreground hover:text-foreground mb-2 sm:mb-0"
            >
              {item}
            </Link>
          ))}
        ...
        <div className="text-center">
          <p className="text-sm text-muted-foreground">© 2025 Kishore Jena Creation. All rights reserved.</p>
