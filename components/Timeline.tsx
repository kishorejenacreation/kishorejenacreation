...
const timelineEvents = [
  {
    ...
    description:
      "Our journey began with a passion for innovative design and digital creativity.",
    details:
  ...
  },
  {
    ...
    description:
      "Delivered breakthrough design solutions for leading brands in the region.",
    details:
  ...
  },
  {
    ...
    description:
      "Recognized for excellence in digital design and user experience.",
    details:
  ...
  },
  {
    ...
    description:
      "Grew our creative team to meet increasing demand for our services.",
    details:
  ...
  },
  {
    ...
    details:
      "Our work gained international attention, leading to collaborations with brands and organizations worldwide, solidifying our position as a creative leader.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            The evolution of Kishore Jena Creation through the years
          </p>
        </motion.div>
